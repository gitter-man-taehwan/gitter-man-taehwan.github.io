...
export function About() {
  ...
  const defaultInfo = {
    ...
    experienceCards: [{"icon":"graduation","title":"단국대학교","period":"2022~현재","description":"도시계획 부동산학과"},{"icon":"award","title":"자격증/수상","period":"2021","description":"설명을 입력하세요"},{"icon":"briefcase","title":"새 경험","period":"2024","description":"설명을 입력하세요"}],
